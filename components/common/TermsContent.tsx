    ...
    <ScrollView>
      <YStack padding="$4" gap="$4">
        ...
        <YStack gap="$2">
          ...
          <Text fontSize="$3" color="$color" lineHeight={24}>
            本アプリの利用にあたって、ユーザーはGoogle アカウントまたはApple
            IDによる認証が必要です。登録されたアカウント情報は適切に管理する責任があります。
          </Text>
        </YStack>
        ...
        <YStack gap="$2">
          ...
          <Text fontSize="$3" color="$color" lineHeight={24}>
            本アプリは、OpenAI社のAPIを使用してAI添削機能および翻訳練習問題の自動生成機能を提供しています。AI機能によって生成された内容は参考情報であり、その正確性や適切性を保証するものではありません。ユーザーは、AI機能の利用に際して、自己の責任において判断し行動するものとします。
          </Text>
        </YStack>
        ...
        <YStack gap="$2">
          ...
          <Text fontSize="$3" color="$color" lineHeight={24}>
            ユーザーは設定画面からいつでもアカウントを削除することができます。アカウント削除後、すべてのデータは削除され、復元することはできません。
          </Text>
        </YStack>
        ...
        <YStack gap="$2">
          ...
          <Text fontSize="$3" color="$color" lineHeight={24}>
            本規約に関するお問い合わせは、下記のメールアドレスまでご連絡ください。{`\n`}
